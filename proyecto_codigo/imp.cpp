...
//Constructor de la clase do_WhileStatement
do_WhileStatement::do_WhileStatement(Exp* c, Body *b):cond(c), body(b) { }
...
//Destructor de la clase do_WhileStatement
do_WhileStatement::~do_WhileStatement() { delete body; delete cond; }
...
//Agregamos el acept al do while statement en int
int do_WhileStatement::accept(ImpVisitor* v){
  return v->visit(this);
}
...
//Agregamos el acept al do while statement en void
void do_WhileStatement::accept(TypeVisitor* v){
  return v->visit(this);
}
